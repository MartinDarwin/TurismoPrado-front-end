...
import { ReserveServiceHotel } from "../service/ReserveServiceHotel";
...
export default function ListReserveHotel() {
  let emptyProduct = {
    id: null,
    name: "",
    lastname: "",
  ...
  useEffect(() => {
    ReserveServiceHotel.getProducts().then((data) => setProducts(data));
  }, []);

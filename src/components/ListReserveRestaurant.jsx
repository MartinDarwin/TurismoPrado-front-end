...
import { ReserveServiceRestaurant } from "../service/ReserveServiceRestaurant";
...
export default function ListReserveRestaurant() {
  let emptyProduct = {
    id: null,
    name: "",
    lastname: "",
  ...
  useEffect(() => {
    ReserveServiceRestaurant.getProducts().then((data) => setProducts(data));
  }, []);

  //Funcion get para listar hoteles
  /*React.useEffect(() => {
    axios.get("http://localhost:8088/reserves").then((response) => {
          ...
          <div className="formgrid grid">
            ...
            <div className="field col">
              ...
              {submitted && !product.numdish && (
                <small className="p-error">Cantidad de platos es requerido.</small>
              )}
            </div>
          </div>
        </Dialog>

...
import { BoatServiceEmp } from "../service/BoatServiceEmp";
...
import ManageBoatGes from "./ManageBoatGes";
import { useNavigate } from "react-router-dom";
import ManageReserveBoat from "./ManageReserveBoat";

export default function ManageBoat() {
  let emptyProduct = {
    id: null,
    name: "",
    image: null,
  ...
  useEffect(() => {
    BoatServiceEmp.getProducts().then((data) => setProducts(data));
  }, []);
  ...
  const header = (
    <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
      <h4 className="m-0">Gestión de alquileres de lanchas</h4>
    ...
    <div>
      ...
      <div>
        ...
        <Dialog
          ...
          header="Detalles de las empresas de alquiler de lanchas"
          modal
          className="p-fluid"

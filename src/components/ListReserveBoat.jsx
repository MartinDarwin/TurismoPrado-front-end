...
import { ReserveServiceBoat } from "../service/ReserveServiceBoat";
...
export default function ListReserveBoat() {
  let emptyProduct = {
    id: null,
    name: "",
    lastname: "",
  ...
  useEffect(() => {
    ReserveServiceBoat.getProducts().then((data) => setProducts(data));
  }, []);

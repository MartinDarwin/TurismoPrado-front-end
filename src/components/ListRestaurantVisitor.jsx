...
import ListDishRestaurantVisitor from "./ListDishRestaurantVisitor";
  ...
  return (
    <div>
      ...
      <div id="derecha">
        ...
        <ListDishRestaurantVisitor id={id} />
        <Maps />
      </div>
    </div>
  );
...
export default ListRestaurantsVisitor;
//<ReserveHotel id={id} />
